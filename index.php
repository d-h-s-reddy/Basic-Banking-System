...
<body style="background-color:#FFFFFF";>
   ...
   <div class="col-md-4 display text-center">
      ...
      <a href="http://localhost/banksystem/viewcustomer.php/" class="btn btn-md btn-dark" id="dis">View Customers</a>
    </div> 
    <div class="text-center mt-5 py-2">
            <p>&copy 2022. Created by <b>Dwarampudi Hari Sankar Reddy</p>
    </div>    
</body>
</html>
